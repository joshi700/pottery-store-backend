...
// @route   POST /api/auth/address/shipping
// @desc    Add shipping address
// @access  Private
router.post('/address/shipping', protect, async (req, res) => {
  try {
    const user = await User.findById(req.user.id);
...
// @route   POST /api/auth/address/billing
// @desc    Add billing address
// @access  Private
router.post('/address/billing', protect, async (req, res) => {
  try {
    const user = await User.findById(req.user.id);
